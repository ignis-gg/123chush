<?php
/**
 * Blog category archive — same blog-grid markup as home.php, filtered to
 * the current category. RECOVERY REBUILD (2026-09-03).
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
}
...
get_header();
$koval_current_cat = get_queried_object();
$koval_categories  = get_categories( array( 'hide_empty' => false, 'exclude' => array( 1 ) ) );
...
<main id="main">
	<div class="archive-head">
		<div class="wrap">
			...
			<h1><?php echo esc_html( $koval_current_cat->name ); ?></h1>
			<?php if ( $koval_current_cat->description ) : ?><p><?php echo esc_html( $koval_current_cat->description ); ?></p><?php endif; ?>
		</div>
	</div>
	...
	<div class="breadcrumbs">
		<div class="wrap">
			...
			<span class="sep">›</span>
			<span><?php echo esc_html( $koval_current_cat->name ); ?></span>
		</div>
	</div>
	...
	<div class="archive-body">
		<div class="wrap">
			...
			<div class="blog-filter-row">
				<div class="svc-tabs">
					<a href="<?php echo esc_url( get_permalink( get_option( 'page_for_posts' ) ) ); ?>" class="svc-tab">Усі статті</a>
					<?php foreach ( $koval_categories as $cat ) : ?>
						<a href="<?php echo esc_url( get_category_link( $cat ) ); ?>" class="svc-tab<?php echo $cat->term_id === $koval_current_cat->term_id ? ' is-active' : ''; ?>"><?php echo esc_html( $cat->name ); ?></a>
					<?php endforeach; ?>
				</div>
			...
			<div class="blog-grid">
				<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
					<article class="blog-card">
						...
						<?php endif; ?>
						<div class="blog-meta">
							<span class="blog-badge"><?php echo esc_html( $koval_current_cat->name ); ?></span>
